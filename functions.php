...
class Paginator
{
	...
	function paginate()
	{
		...
		if ($this->num_pages > 10) {
			$this->return = ($this->current_page != 1 and $this->items_total >= 10) ? "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $this->get_page_url($prev_page) . "\">&laquo;</a></li>" : "<li class=\"page-item\"><a class=\"page-link\">&laquo;</a></li>";
			...
			for ($i = 1; $i <= $this->num_pages; $i++) {
				if ($this->range[0] > 2 and $i == $this->range[0]) $this->return .= "<li class=\"page-item disabled\"><a class=\"page-link\">...</a></li>";
				// loop through all pages. if first, last, or in range, display
				if ($i == 1 or $i == $this->num_pages or in_array($i, $this->range)) {
					$this->return .= ($i == $this->current_page and $this->get('page') != 'All') ? "<li class=\"page-item active\"><a class=\"page-link\" title=\"Go to page $i of $this->num_pages\" href=\"#\">$i <span class=\"sr-only\">(current)</span></a></li>" : "<li class=\"page-item\"><a class=\"page-link\" title=\"Go to page $i of $this->num_pages\" href=\"" . $this->get_page_url($i) . "\">$i</a></li>";
				}
				if ($this->range[$this->mid_range - 1] < $this->num_pages - 1 and $i == $this->range[$this->mid_range - 1]) $this->return .= "<li class=\"page-item disabled\"><a class=\"page-link\">...</a></li>";
			}
			$this->return .= (($this->current_page != $this->num_pages and $this->items_total >= 10) and ($this->get('page') != 'All')) ? "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $this->get_page_url($next_page) . "\">&raquo;</a></li>" : "<li class=\"page-item\"><a class=\"page-link\">&raquo;</a></li>";
			// $this->return .= ($_GET['page'] == 'All') ? "<a class=\"current\" style=\"margin-left:10px\" href=\"#\">All</a> \n":"<a class=\"paginate\" style=\"margin-left:10px\" href=\"".$this->get_page_url(1)."\">All</a> \n";
		} else {
			for ($i = 1; $i <= $this->num_pages; $i++) {
				$this->return .= ($i == $this->current_page) ? "<li class=\"page-item active\"><a class=\"page-link\" href=\"#\">$i</a></li>" : "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $this->get_page_url($i) . "\">$i</a></li>";
			}
			// $this->return .= "<a class=\"page-link\" href=\"".$this->get_page_url(1)."\">All</a> \n";
		}
	...
	function display_pages()
	{
		...
		return '<ul class="pagination justify-content-center">' . $this->return . '</ul>';
	}
}