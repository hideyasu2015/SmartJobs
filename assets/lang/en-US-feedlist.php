...
$feedlist = array(
		...
		array(
				'title' => 'Indeed',
				'url' => 'http://api.indeed.com/ads/apisearch?sort=date&publisher='.$indeed_publisher_id.'&q='.space2plus($key).'&l='.space2plus(get_location_nicename(@$query_vars['loc'])).'&userip='.$_SERVER['REMOTE_ADDR'].'&v=2&chnl='.$indeed_channel.'&useragent='.$_SERVER['HTTP_USER_AGENT'],
				'folder' => 'Jobs',
				'api' => true
		),
		array(
