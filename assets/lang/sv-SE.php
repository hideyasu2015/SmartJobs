...
$categories = "Arkitektur,Byggnad,Konstruktion,Bank,Finanstjänster,Beklädnad,Mode -Textil,Bilar,Fordon,Detaljhandel,Grossisthandel,Elektronik,Robotics,Fastighet,Flyg,Försvar,Försäkring,Försäljning,HR,Rekrytering,Hälsovård,Informationsteknik,Telekommunikation,Ingenjörsarbete,Inköp,Jordbruk,Skogsbruk,Fiskindustri,Juridik,Skatt,Konst,Design,Underhållning,Konsulation,Kundservice,Call Center,Kvalitetssäkring,Ledning,Styrelse,Livsmedelsframställning,Maritimt,Sjöfart,Skeppsbyggning,Marknadsföring,Public relations,Media,Annonsering,Offentlig sektor,Olja,Gas,Gruvdrift,Polis,Säkerhet,Produktion,Underhåll,Publicering,Tryckning,Redovisning,Revision,Restaurang,Matbetjäning,Sekreterare,Administration,Skönhet,Sport,Fritid,Nöje,Stål,Metall,Transport,Logistik,Trä,Papper,Möbler,Turism,Resa,Hotell,Utbildning,Träning,Vetenskap,Forskning,Utveckling,Välgörenhet,Vård och Omsorg,Översättning,Tolk";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations="Blekinge,Dalarna,Gotland,Gävleborg,Halland,Jämtland,Jönköping,Kalmar,Kronoberg,Norrbotten,Skåne,Storstockholm,Södermanland,Uppsala,Värmland,Västerbotten,Västernorrland,Västmanland,Västra Götaland,Örebro,Östergötland";
