...
$categories = "Accounting,Arts,Administrative,Advertising,Automotive,Banking,Biotech,College,Computer,Construction,Criminal Giustizia, Counselling, Design, Educazione, Ingegneria, Ingegneria Elettrica, Spettacolo, Entry Level, Executive, Finanza, Franchising, federale, la scienza forense, Generale del Lavoro, Graphic Designer, Governo, alimentari, sanità, ospitalità, HVAC, Risorse Umane, Information Technology , assicurazioni, inventario, Internet, Investment banking, Giornalismo, Law Enforcement, Legale, Consulenza, MBA, Produzione, Marketing, assistente medico, fatturazione medica, trascrizione medica, industria musicale, NHS, Infermiere, Insegnare online, Center Direzione Generale, farmaceutica, Paralegal , idraulici, Project manager, Editoria, Psicologia, immobiliare, Assunzione, Energia rinnovabile, Ricerca, Ristorante, Vendita al dettaglio, vendite, Scienza, Skilled Labor Trades, testing del software, Sport Management, Pianificazione strategica, Supply Chain, Telecomunicazioni, Formazione, Trascrizione, Viaggi, assistenza infermieristica Viaggi, Viaggiare, Trucking, camionista, Università, veterinaria, Deposito, Web Design";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Abruzzo,Basilicata,Calabria,Campania,Emilia Romagna,Friuli Venezia Giulia,Lazio,Liguria,Lombardia,Marche,Molise,Piemonte,Puglia,Sardegna,Sicilia,Toscana,Trentino Alto Adige,Umbria,Valle d'Aosta,Veneto";
...
$about_text= "<p>Job Aggregatore is an all-in-one Job Search Engine for Every Country.</p><p>Find the latest Job listings posted on job banks, job search engine sites and job directories.</p>";
...
$strings['SUFFIX_JOBS'] = '%s Offerte di lavoro';
$strings['JOBS'] = 'Offerte di lavoro';
$strings['PREFIX_IN'] = ' in %s';
$strings['CLOSE'] = 'Close';
$strings['SEARCH'] = 'RICERCA';
$strings['START_NEW_SEARCH'] = 'Start new search';
$strings['LOADING'] = 'Loading';
$strings['PLACEHOLDER_SEARCH'] = 'Ricerca';
$strings['PLACEHOLDER_LOCATION'] = 'Posizione';
$strings['BTN_LEARN_MORE'] = 'Saperne di più';
$strings['BTN_JOB_AGGREGATOR'] = 'Job Aggregatore';
$strings['BTN_BROWSE_JOBS'] = 'Browse Job';
$strings['BTN_FIND_YOUR_JOB'] = 'Find your job';

$strings['HEADING_SEARCH_JOBS'] = 'Cerca Lavoro';
$strings['LEADING_FIND_JOBS_BY_KEYWORD_OR_LOCATION'] = 'Cerca e trova lavoro per parola chiave o località';
$strings['TEXT_SEARCH_ON'] = 'Cerca sul lavoro distacco siti popolari in una sola volta con un solo una volta cercare o navigare posti di lavoro per categoria o sottostante.';
$strings['TEXT_NO_RESULT'] = '<p class="no-jobs">No job listings match your search %s on %s</p>';
$strings['PUBLISHED_ON'] = 'Published on';

$strings['HEADING_CATEGORIES'] = 'Categorie';
$strings['DESCRIPTION_CATEGORIES'] = 'Search multiple job sites at once. One search to find all job postings at %s.';

$strings['HEADING_LOCATIONS'] = 'Lavoro per luogo';
...
$strings['MENU_SEARCH'] = 'Ricerca';
$strings['MENU_BROWSE'] = 'Browse';
$strings['MENU_CATEGORIES'] = 'Categorie';
$strings['MENU_LOCATIONS'] = 'Lavoro per luogo';
$strings['MENU_LATEST'] = 'Ultimo';
$strings['MENU_LANGUAGE'] = 'Lingua';
