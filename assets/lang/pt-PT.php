...
$categories = "Aeroespacial,Defesa,Agricultura,Silvicultura,Pesca,Arquitetura,Construção,Artes,Design,Entretenimento,Caridade,Organizações Filantrópicas,Ciências,Pesquisa,Desenvolvimento,Comprador,Comércio Atacadista e Varejista,Consultoria,Assessoria,Auditoria,Contabilidade,Auditoria,Controle de qualidade,Decoração,Papéis,Madeira,Editora,Gráfica,Educação,Profissionalização,Eletrônica,Robótica,Engenharia,Esportes,Lazer,Recreação,Estética Corporal,Finanças,Bancário,Fiscal,Legal,Gerenciamento,Executivo,Diretoria,Imobiliária,Indústria Alimentícia,Indústria Automobilística,Indústria Metalúrgica,Siderúrgica,Indústria Petrolífera,Gás,Mineração,Indústria Têxtil,Moda,Marketing,Relações públicas,Marítimo,Construção Naval,Produção,Manufatura,Manutenção,Publicidade e Propaganda,Recursos Humanos,Restaurantes,Buffet,Saúde,Secretariado e Administrativo,Segurança,Vigilância,Seguros,Serviço Social,Serviço ao Cliente,Call center,Setor Público,Tecnologia da Informação,Telecom,Traduções,Transporte,Logística,Turismo,Hotelaria,Vendas";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Açores,Distrito de Aveiro,Distrito de Beja,Distrito de Braga,Distrito de Bragança,Distrito de Castelo Branco,Distrito de Coimbra,Distrito de Faro,Distrito de Guarda,Distrito de Leiria,Distrito de Lisboa,Distrito de Portalegre,Distrito de Porto,Distrito de Santarém,Distrito de Setúbal,Distrito de Viana do Castelo,Distrito de Vila Real,Distrito de Viseu,Distrito de Évora,Madeira";
