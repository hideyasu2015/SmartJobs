...
$categories = "Achats,Agriculture,Industrie Forestière,Pêche,Agro-alimentaire,Architecture,BTP,Art,Créativité,Spectacles,Assurances,Automobile,Aéronautique,Défense,Banque,Finance,Bois,Ameublement,Papier,Bénévolat,Associations,Commerce,Grande Distribution,Commercial,Ventes,Comptabilité,Contrôle de gestion,Conseil,Expertise,Audit,Directeurs,Gérants,Edition,Imprimerie,Electronique,Robotique,Enseignement,Formations,Immobilier,Informatique,Télécom,Ingénieurs et Techniciens,Journalisme,Media,Publicité,Juristes,Fiscalistes,Maintien de l'Ordre,Sécurité,Maritime,Nautisme,Naval,Marketing,Communication,Métallurgie,Sidérurgie,Plasturgie,Production,Maintenance,Pétrole et Gaz,Mines,Energie,Qualité,Méthodes,Ressources Humaines,Restauration,Santé,Sciences,Etudes,Recherche,Secrétariat,Assistance,Accueil,Secteur Public,Services Conso,Centres d'Appels,Services sociaux,Soins du Corps,Beauté,Sports,Loisirs,Textile,Habillement,Mode,Tourisme,Hôtellerie,Traduction,Documentation,Transports,Logistique";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Alsace,Aquitaine,Auvergne,Basse-Normandie,Bourgogne,Bretagne,Centre,Champagne-Ardenne,Corse,Franche-Comte,Haute-Normandie,Ile-de-France,Languedoc-Roussillon,Limousin,Lorraine,Midi-Pyrénées,Nord-Pas-de-Calais,Pays de Loire,Picardie,Poitou-Charentes,Provence-Alpes-Cote d'Azur,Rhône-Alpes,Bordeaux,Brest,Clermont-Ferrand,Dijon,Grenoble,Le Havre,Le Mans,Lille,Lyon,Marseille,Montpellier,Nantes,Nice,Paris,Reims,Rennes,St. Etienne,Strasbourg,Toulon,Toulouse";
...
$strings['HEADING_SEARCH_JOBS'] = 'Recherche d\'emploi';
...
$strings['DESCRIPTION_CATEGORIES'] = 'Recherche de plusieurs sites d\'emploi à la fois. Une recherche pour trouver toutes les offres d\'emploi à %s.';
