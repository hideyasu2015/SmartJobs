...
$locations = "Hlavní město Praha,Jihomoravský kraj,Jihočeský kraj,Karlovarský kraj,Královéhradecký kraj,Liberecký kraj,Moravskoslezský kraj,Olomoucký kraj,Pardubický kraj,Plzeňský kraj,Středočeský kraj,Vysočina,Zlínský kraj,Ústecký kraj,Brno,Chomutov,Děčín,Frýdek-Místek,Havířov,Hradec Králové,Jihlava,Karlovy Vary,Karviná,Kladno,Liberec,Olomouc,Opava,Ostrava,Pardubice,Plzeň,Praha,Teplice,Zlín,Ústí nad Labem,České Budějovice";
