...
$categories = "Arkitektur,Bygge,Konstruktion,Bank- og Finansvæsen,Beklædning,Mode,Tekstil,Bogholderi,Revision,Ejendom,Elektroteknik,Robotteknologi,Flyvning,Forsvar,Forlagsvirksomhed,Trykkeri,Forsikring,HR og Personale,Handel,Idræt,Fritid,Indkøb,Informationsteknologi,Telekommunikation,Ingeniørarbejde,Jern,Metal,Jura,Skat,Konsultation,Kultur,Design,Underholdning,Kundeservice,Telfoncentrale,Kvalitetskontrol,Landbrug,Skovbrug,Fiskeri,Ledelse,Bestyrelse,Marketing,PR,Medier,Reklame,Mekanik,Auto,Nærings- og Nydelsesmidler,Offentlig sektor,Olie,Gas,Minedrift,Oversættelse,Personlig pleje,Politi,Sikkerhed,Produktion,Vedligeholdelse,Restaurant,Køkken,Salg,Sekretær,Personlig Assistent,Administration,Social,Spedition,Logistik,Sundhed,Søfart,Skibsbygning,Træ,Papir,Møbler,Turisme,Rejse,Hotel,Undervisning,Vejledning,Velgørenhed,Frivillig,Videnskab,Forskning,Udvikling";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Hovedstaden,Midtjylland,Nordjylland,Sjælland,Syddanmark,Storkøbenhavn";
