...
$categories = "Architektur,Bauwirtschaft,Aus- und Weiterbildung,Automobilindustrie,Bank- und Finanzwesen,Buchhaltung,Auditing,Design,Kunst,Unterhaltung,Druck- und Verlagswesen,Einkauf,Elektronik,Engineering,Forschung,Entwicklung,Wissenschaft,Gastronomie,Catering,Gesundheitswesen,Groß- und Einzelhandel,Herstellung,Wartung,Holz- Möbel- und Papierwirtschaft,Immobilien,Informationstechnologie,Kundenservice,Call Center,Körperpflege,Land- und Forstwirtschaft,Fischerei,Lebensmittelwirtschaft,Luft- und Raumfahrttechnik,Management,Vorstand,Marketing,Public Relations,Medien,Werbung,Mode,Textilwesen,Personalleitung,Qualitätssicherung,Rechtswesen,Steuern,Schifffahrt,Schiffbau,Sekretär,PAs,Administration,Sicherheit,Gesetzeshütung,Soziale Pflege,Spendenorganisationen,Sport,Freizeitindustrie,Stahl- und Metallerzeugnisse,Tourismus,Hotelwirtschaft,Transport,Logistik,Unternehmensberatung,Verkauf,Versicherungswesen,Öffentlicher Dienst,Öl- und Gasgewinnung,Bergbau,Übersetzung";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Aachen,Augsburg,Bielefeld,Bochum,Bonn,Braunschweig,Chemnitz,Dortmund,Dresden,Duisburg,Düsseldorf,Erfurt,Essen,Frankfurt am Main,Freiburg,Gelsenkirchen,Halle,Hamm,Hannover,Karlsruhe,Kassel,Kiel,Krefeld,Köln,Leipzig,Lübeck,Magdeburg,Mainz am Rhein,Mannheim,Mönchengladbach,München,Münster,Nürnberg,Oberhausen,Rostock,Saarbrücken,Stuttgart,Wiesbaden,Wuppertal ";
...
$strings['START_NEW_SEARCH'] = 'Neue Suche';
$strings['LOADING'] = 'Loading';
$strings['PLACEHOLDER_SEARCH'] = 'Suche';
$strings['PLACEHOLDER_LOCATION'] = 'Ort';
$strings['BTN_LEARN_MORE'] = 'Lern mehr';
$strings['BTN_JOB_AGGREGATOR'] = 'Job Aggregator';
$strings['BTN_BROWSE_JOBS'] = 'Browse Job';
$strings['BTN_FIND_YOUR_JOB'] = 'Find your job';

$strings['HEADING_SEARCH_JOBS'] = 'Arbeit suchen';
$strings['LEADING_FIND_JOBS_BY_KEYWORD_OR_LOCATION'] = 'Jobs nach Stichwort oder Ort suchen';
...
$strings['PUBLISHED_ON'] = 'Veröffentlicht auf';

$strings['HEADING_CATEGORIES'] = 'Kategorien';
$strings['DESCRIPTION_CATEGORIES'] = 'Search multiple job sites at once. One search to find all job postings at %s.';

$strings['HEADING_LOCATIONS'] = 'Standorte';
...
$strings['HEADING_JOBSITES_ADDED'] = 'Jobseiten hinzugefügt';
...
$strings['HEADING_OUR_OFFICE'] = 'Unsere Firma';

$strings['MENU_HOME'] = 'Home';
$strings['MENU_SEARCH'] = 'Suche';
$strings['MENU_BROWSE'] = 'Browse';
$strings['MENU_CATEGORIES'] = 'Kategorien';
$strings['MENU_LOCATIONS'] = 'Ort';
$strings['MENU_LATEST'] = 'Neueste';
$strings['MENU_LANGUAGE'] = 'Language';
$strings['MENU_DOWNLOAD'] = 'Download';

$strings['MENU_ABOUT_US'] = 'Über uns';
