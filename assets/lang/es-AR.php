...
$categories = "Agricultura,Pesca,Arquitectura,Construcción,Arte,Cultura,Audiovisuales,Atención al Cliente,Call Center,Automoción y Vehículos de Motor,Aviación-Industria Aeroespacial-Defensa,Banca y Servicios Financieros,Ciencias,Investigación,Desarrollo,Compras,Consultoría,Asesoría,Auditoría,Contabilidad,Control de Gestión,Control de Calidad,Deportes y Ocio,Dirección General,Editorial e Imprenta,Electrónica,Robótica,Enseñanza,Formación,Fabricación y Mantenimiento,Industria Agroalimentaria,Industria Maderera,Industria textil,Moda,Informática,Telecomunicaciones,Ingeniería,Inmobiliaria,Legal,Fiscalidad,Logística,Transporte,Marítimo,Construcción Naval,Márketing y Relaciones Públicas,Organizaciones benéficas,Petróleo y Gas,Minería,Publicidad,Periodismo,Recursos Humanos,Restaurantes,Servicios Alimenticios,Salud,Belleza,Sanidad,Secretariado,Administración,Sector Público,Seguridad,Vigilancia,Seguridad Social,Seguros,Siderurgia,Metalurgia,Plastico,Traducción,Documentacion,Turismo,Viajes,Hostelería,Venta al por Menor-Venta al por Mayor,Ventas";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Buenos Aires,Catamarca,Chaco,Chubut,Corrientes,Córdoba,Entre Ríos,Formosa,Jujuy,La Pampa,La Rioja,Mendoza,Misiones,Neuquén,Río Negro,Salta,San Juan,San Luis,Santa Cruz,Santa Fe,Santiago del Estero,Tierra del Fuego,Tucumán";
