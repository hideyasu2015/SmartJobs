...
$categories = "Accounting,Arts,Administrative,Advertising,Automotive,Banking,Biotech,College,Computer,Construction,Criminal Justicia, Asesoramiento, Diseño, Educación, Ingeniería, Ingeniería Eléctrica, entretenimiento, de nivel de entrada, Ejecutivo, Finanzas, Franquicias, Federal, la ciencia forense, General de Trabajo, Diseñador Gráfico, Gobierno, Comestibles, Salud, Hostelería, HVAC, Recursos Humanos, Tecnología de la Información , Seguros, Inventario, Internet, banca de inversión, Periodismo, Aplicación de la Ley, Legal, Consultoría de Gestión, MBA, fabricación, comercialización, ayudante médico, facturación médica, la transcripción médica, industria de la música, NHS, Enfermera, Enseñanza Online, Operartions, Farmacéutica, Paralegal , Plomería, gerente de Proyectos, Publicaciones, Psicología, Bienes Raíces, Contratación, Energía renovable, Investigación, Restaurante, Venta al por menor, ventas, Ciencia, Comercios expertos laborales, pruebas de software, Gestión Deportiva, Planificación Estratégica, cadena de Suministro, Telecomunicaciones, Formación, Transcripción, Viajes, Viajes de enfermería, Viajar, Trucking, conductor de camiones, Universidad, Veterinaria, Almacén, Diseño web";

// DEFAULT LOCATIONS: You can change the default locations below.
$locations = "Andalucía,Aragón,Asturias,Cantabria,Castilla León,Castilla la Mancha,Catalunya,Ceuta,Comunidad Valenciana,Comunidad de Madrid,Euskadi,Extremadura,Galicia,Islas Baleares,Islas Canarias,La Rioja,Melilla,Navarra,Región de Murcia";
...
$strings['HEADING_SEARCH_JOBS'] = 'Buscar Empleos';
