              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  <input type="text" class="form-control input-lg" name="keyword" value="<?php if (isset($q) && !empty($q)) {
                    ...
                    id="q" placeholder="<?php echo _text('PLACEHOLDER_SEARCH'); ?>">
                </div>
                ...
                <div class="form-group col-md-4">
                  <input type="text" class="form-control input-lg" name="job_location" value="<?php if (isset($query_vars['loc']) && !empty($query_vars['loc'])) {
                    ...
                    id="loc" placeholder="<?php echo _text('PLACEHOLDER_LOCATION'); ?>">
                </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 float-right" id="sidebar">
            ...
            <!-- SALARY CHECK WIDGET-->
            <?php if (isset($salarycheck) && $salarycheck == 'on') : ?>
            <?php if (isset($q) && !empty($q)) {; ?>


            <div class="card border-light mb-12 d-none d-lg-block sidebar-element">
              <div class="card-header">Salary checker</div>
              <div class="card-body">
                <h4 class="card-title"> Are you being paid in line with other professionals at your level?</h4>
                <p class="card-text">
                <div class="gdWidget"><a
                    href="https://www.glassdoor.com/api/api.htm?version=1&action=salaries&t.s=w-m&t.a=c&format=300x250-chart&jobTitle=<?php echo $q; ?>"
                    target="_gd"><?php echo $q; ?> Salaries</a> | More details for <a
                    href="https://www.glassdoor.com/api/api.htm?version=1&action=jobs&t.s=w-m&t.a=c&jobTitle=<?php echo $q; ?>"
                    target="_gd"><?php echo $q; ?> Jobs</a> | <a
                    href="https://www.glassdoor.com/Salaries/index.htm?t.s=w-m&t.a=c" target="_gd">Salary</a></div>
                <script src="https://www.glassdoor.com/static/js/api/widget/v1.js"></script>
                </p>
              </div>
            </div>
