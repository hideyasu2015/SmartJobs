    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        <a class="navbar-brand" href="<?php echo $siteurl; ?>"><i class="fa fa-briefcase"></i>Smart Jobs</a>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo get_site_url(array(), 'search'); ?>"><i
                  class="fas fa-search"></i> <?php echo _text('MENU_SEARCH'); ?></a></li>
